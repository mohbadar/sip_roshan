  ...
  void _loadSettings() async {
    ...
    setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'wss://cloudpbx.roshan.af:5080';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? 'sip:221@cloudpbx.roshan.af';
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'Idevelop';
      _passwordController.text =
          _preferences.getString('password') ?? r'somepassword';
      _authorizationUserController.text =
          _preferences.getString('auth_user') ?? '221';
    });
  }
